...
public class Liker {
    ...
    public Liker() {}
    public Liker(String itemId, String itemPicture, String itemName, String type, List<String> departments, List<String> year, String fullType, String itemType, String likedItemId) {
        this.itemId = itemId;
